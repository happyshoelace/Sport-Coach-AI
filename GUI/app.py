...
def modelOutputPage():
    ...
    # predicted_class, confidence_score = classify(video_url)
    # now pass video_url (a string) to your template
    '''
    return render_template('modeloutput.html',
                           video_url=os.path.splitext(video_url)[0]"output.mp4",
                           footworkClass=predicted_class,
                           classConfidence=confidence_score)
    '''
    return render_template('modeloutput.html',
                           video_url=video_url,
